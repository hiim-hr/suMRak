...
> [!NOTE]
> suMRak comes with its own carefully written [MANUAL](https://github.com/Sternak-Marko/suMRak/blob/main/Manual_Beta_v0.9.pdf), which explains all of the components in detail and provides recommended workflow steps.
