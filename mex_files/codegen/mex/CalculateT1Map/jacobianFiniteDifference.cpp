                                     ...
                                     const c_struct_T &FiniteDifferences)
{
  ...
  JacCeqTrans.set_size(&hb_emlrtRTEI, &sp, 2, fCurrent.size(1));
  a__3[0] = x[0];
  a__3[1] = x[1];
  ...
  if (fCurrent.size(1) < 1) {
    ...
    i1 = fCurrent.size(1);
    if ((i1 < 1) || (i1 > i)) {
      emlrtDynamicBoundsCheckR2012b(i1, 1, i, &p_emlrtBCI, (emlrtConstCTX)&sp);
    }
  }
  t4_f2[0] = i1;
  t4_f2[1] = 2;
  ...
  b_JacCeqTrans[1] = 2;
  emlrtSubAssignSizeCheckR2012b(&t4_f2[0], 2, &b_JacCeqTrans[0], 2, &e_emlrtECI,
                                (emlrtCTX)&sp);
                                   ...
                                   boolean_T &evalOK)
{
  ...
  b_JacCeqTrans[0] = JacCeqTrans.size(1);
  b_JacCeqTrans[1] = 2;
  emlrtSubAssignSizeCheckR2012b(&t3_f2[0], 2, &b_JacCeqTrans[0], 2, &e_emlrtECI,
                                (emlrtCTX)&sp);
  loop_ub = JacCeqTrans.size(1);
  for (i = 0; i < 2; i++) {
    for (i1 = 0; i1 < loop_ub; i1++) {
                                     ...
                                     const c_struct_T &FiniteDifferences)
{
  ...
  b_JacCeqTrans[0] = JacCeqTrans.size(1);
  b_JacCeqTrans[1] = 2;
  emlrtSubAssignSizeCheckR2012b(&t0_f2[0], 2, &b_JacCeqTrans[0], 2, &e_emlrtECI,
                                (emlrtCTX)&sp);
  loop_ub = JacCeqTrans.size(1);
  for (i = 0; i < 2; i++) {
    for (i1 = 0; i1 < loop_ub; i1++) {
                                 ...
                                 boolean_T &evalOK)
{
  ...
  b_JacCeqTrans[0] = JacCeqTrans.size(1);
  b_JacCeqTrans[1] = 2;
  emlrtSubAssignSizeCheckR2012b(&t5_f2[0], 2, &b_JacCeqTrans[0], 2, &e_emlrtECI,
                                (emlrtCTX)&sp);
  loop_ub = JacCeqTrans.size(1);
  for (i = 0; i < 2; i++) {
    for (i1 = 0; i1 < loop_ub; i1++) {
