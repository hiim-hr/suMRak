...
//
// _coder_CalculateT2Map_api.cpp
//
// Code generation for function '_coder_CalculateT2Map_api'
//
...
static void emlrt_marshallIn(const emlrtStack &sp,
                             const mxArray *T2raw_reordered_reshaped,
                             const char_T *identifier,
                             coder::array<real_T, 2U> &y);
                             ...
                             coder::array<real_T, 2U> &y)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  emlrt_marshallIn(sp, emlrtAlias(T2raw_reordered_reshaped), &thisId, y);
  emlrtDestroyArray(&T2raw_reordered_reshaped);
}
...
// End of code generation (_coder_CalculateT2Map_api.cpp)
