  ...
  if (obj.isEmptyNonlcon) {
    ...
    while ((!exitg1) && (idx < 2)) {
      ...
      if (i != varargout_2.size(0)) {
        emlrtSubAssignSizeCheck1dR2017a(i, varargout_2.size(0), &e_emlrtECI,
                                        &b_st);
      }
      b_idx = 1;
      ...
      xk[idx] = temp;
      obj.f_1 = 0.0;
      obj.cEq_1.set_size(&hb_emlrtRTEI, &st, varargout_2.size(0));
        ...
        if (!modifiedStep) {
          ...
          if ((!obj.hasBounds) || modifiedStep) {
            ...
            while (evalOK && (b_idx <= obj.mEq)) {
              i = obj.cEq_1.size(0);
              if ((b_idx < 1) || (b_idx > i)) {
                emlrtDynamicBoundsCheckR2012b(b_idx, 1, i, &t_emlrtBCI, &b_st);
              }
      ...
      if (guard1) {
        ...
        for (int32_T idx_row{0}; idx_row < b_idx; idx_row++) {
          ...
          if ((idx_row + 1 < 1) || (idx_row + 1 > i1)) {
            emlrtDynamicBoundsCheckR2012b(idx_row + 1, 1, i1, &u_emlrtBCI, &st);
          }
          ...
          i1 = (idx + (idx_row << 1)) + 1;
          if ((i1 < 1) || (i1 > i)) {
            emlrtDynamicBoundsCheckR2012b(i1, 1, i, &u_emlrtBCI, &st);
          }
          JacCeqTrans[i1 - 1] =
