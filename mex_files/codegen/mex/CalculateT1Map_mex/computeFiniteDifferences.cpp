  ...
  if (obj.isEmptyNonlcon) {
    ...
    while ((!exitg1) && (idx < 2)) {
      ...
      if (i != varargout_2.size(0)) {
        emlrtSubAssignSizeCheck1dR2017a(i, varargout_2.size(0), &g_emlrtECI,
                                        &b_st);
      }
      b_idx = 1;
      ...
      xk[idx] = temp;
      obj.f_1 = 0.0;
      obj.cEq_1.set_size(&ob_emlrtRTEI, &st, varargout_2.size(0));
        ...
        if (!modifiedStep) {
          ...
          if ((!obj.hasBounds) || modifiedStep) {
            ...
            while (evalOK && (b_idx <= obj.mEq)) {
              i = obj.cEq_1.size(0);
              if ((b_idx < 1) || (b_idx > i)) {
                emlrtDynamicBoundsCheckR2012b(b_idx, 1, i, &w_emlrtBCI, &b_st);
              }
      ...
      if (guard1) {
        ...
        for (int32_T idx_row{0}; idx_row < b_idx; idx_row++) {
          ...
          if ((idx_row + 1 < 1) || (idx_row + 1 > i1)) {
            emlrtDynamicBoundsCheckR2012b(idx_row + 1, 1, i1, &x_emlrtBCI, &st);
          }
...
boolean_T c_computeFiniteDifferences(
    const emlrtStack &sp, c_struct_T &obj,
    const ::coder::array<real_T, 2U> &cEqCurrent, real_T xk[2],
    ::coder::array<real_T, 2U> &JacCeqTrans, const real_T ub[2])
{
  ...
  if (obj.isEmptyNonlcon) {
    ...
    while ((!exitg1) && (idx < 2)) {
      ...
      c_st.site = &jb_emlrtRSI;
      d_st.site = &v_emlrtRSI;
      levenbergMarquardt::c_driver_anonFcn1(d_st, obj.nonlin.workspace.fun, xk,
                                            varargout_2);
      i = obj.cEq_1.size(0);
      if (i != varargout_2.size(0)) {
        emlrtSubAssignSizeCheck1dR2017a(i, varargout_2.size(0), &g_emlrtECI,
      ...
      if (!evalOK) {
        if (!modifiedStep) {
          ...
          if ((!obj.hasBounds) || modifiedStep) {
            ...
            c_st.site = &jb_emlrtRSI;
            d_st.site = &v_emlrtRSI;
            levenbergMarquardt::c_driver_anonFcn1(
                d_st, obj.nonlin.workspace.fun, xk, obj.cEq_1);
            i = obj.cEq_1.size(0);
            if (varargout_2.size(0) != i) {
              emlrtSubAssignSizeCheck1dR2017a(varargout_2.size(0), i,
